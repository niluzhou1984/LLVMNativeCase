...
PhysXProfileSDK_debug_common_cflags  +=   -fPIC   -fno-exceptions -fno-rtti 
...
PhysXProfileSDK_debug_lflags  += -ldl
...
PhysXProfileSDK_debug_bin      := ./../../../Lib/cygwin32_llvm/libPhysXProfileSDKDEBUG.a
...
$(PhysXProfileSDK_debug_bin): $(PhysXProfileSDK_debug_obj) 
	mkdir -p `dirname ./../../../Lib/cygwin32_llvm/libPhysXProfileSDKDEBUG.a`
	@$(AR)  $(PhysXProfileSDK_debug_bin) $(PhysXProfileSDK_debug_obj)
...
PhysXProfileSDK_checked_common_cflags  +=   -fPIC   -fno-exceptions -fno-rtti 
...
PhysXProfileSDK_checked_lflags  += -ldl
...
PhysXProfileSDK_checked_bin      := ./../../../Lib/cygwin32_llvm/libPhysXProfileSDKCHECKED.a
...
$(PhysXProfileSDK_checked_bin): $(PhysXProfileSDK_checked_obj) 
	mkdir -p `dirname ./../../../Lib/cygwin32_llvm/libPhysXProfileSDKCHECKED.a`
	@$(AR)  $(PhysXProfileSDK_checked_bin) $(PhysXProfileSDK_checked_obj)
	$(ECHO) building $@ complete!
...
PhysXProfileSDK_profile_common_cflags  +=   -fPIC   -fno-exceptions -fno-rtti 
...
PhysXProfileSDK_profile_lflags  += -ldl
...
PhysXProfileSDK_profile_bin      := ./../../../Lib/cygwin32_llvm/libPhysXProfileSDKPROFILE.a
...
$(PhysXProfileSDK_profile_bin): $(PhysXProfileSDK_profile_obj) 
	mkdir -p `dirname ./../../../Lib/cygwin32_llvm/libPhysXProfileSDKPROFILE.a`
	@$(AR)  $(PhysXProfileSDK_profile_bin) $(PhysXProfileSDK_profile_obj)
	$(ECHO) building $@ complete!
...
PhysXProfileSDK_release_common_cflags  +=   -fPIC   -fno-exceptions -fno-rtti 
...
PhysXProfileSDK_release_lflags  += -ldl
...
PhysXProfileSDK_release_bin      := ./../../../Lib/cygwin32_llvm/libPhysXProfileSDK.a
...
$(PhysXProfileSDK_release_bin): $(PhysXProfileSDK_release_obj) 
	mkdir -p `dirname ./../../../Lib/cygwin32_llvm/libPhysXProfileSDK.a`
	@$(AR)  $(PhysXProfileSDK_release_bin) $(PhysXProfileSDK_release_obj)
	$(ECHO) building $@ complete!
