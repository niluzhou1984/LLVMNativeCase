...
SceneQuery_debug_common_cflags  +=   -fPIC   -fno-exceptions -fno-rtti 
...
SceneQuery_debug_bin      := ./../../../Lib/cygwin32_llvm/libSceneQueryDEBUG.a
...
$(SceneQuery_debug_bin): $(SceneQuery_debug_obj) 
	mkdir -p `dirname ./../../../Lib/cygwin32_llvm/libSceneQueryDEBUG.a`
	@$(AR)  $(SceneQuery_debug_bin) $(SceneQuery_debug_obj)
...
SceneQuery_checked_common_cflags  +=   -fPIC   -fno-exceptions -fno-rtti 
...
SceneQuery_checked_bin      := ./../../../Lib/cygwin32_llvm/libSceneQueryCHECKED.a
...
$(SceneQuery_checked_bin): $(SceneQuery_checked_obj) 
	mkdir -p `dirname ./../../../Lib/cygwin32_llvm/libSceneQueryCHECKED.a`
	@$(AR)  $(SceneQuery_checked_bin) $(SceneQuery_checked_obj)
	$(ECHO) building $@ complete!
...
SceneQuery_profile_common_cflags  +=   -fPIC   -fno-exceptions -fno-rtti 
...
SceneQuery_profile_bin      := ./../../../Lib/cygwin32_llvm/libSceneQueryPROFILE.a
...
$(SceneQuery_profile_bin): $(SceneQuery_profile_obj) 
	mkdir -p `dirname ./../../../Lib/cygwin32_llvm/libSceneQueryPROFILE.a`
	@$(AR)  $(SceneQuery_profile_bin) $(SceneQuery_profile_obj)
	$(ECHO) building $@ complete!
...
SceneQuery_release_common_cflags  +=   -fPIC   -fno-exceptions -fno-rtti 
...
SceneQuery_release_bin      := ./../../../Lib/cygwin32_llvm/libSceneQuery.a
...
$(SceneQuery_release_bin): $(SceneQuery_release_obj) 
	mkdir -p `dirname ./../../../Lib/cygwin32_llvm/libSceneQuery.a`
	@$(AR)  $(SceneQuery_release_bin) $(SceneQuery_release_obj)
	$(ECHO) building $@ complete!
