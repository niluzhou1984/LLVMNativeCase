...
PhysXCommon_debug_common_cflags  +=   -fPIC    -fno-exceptions -fno-rtti 
...
PhysXCommon_debug_bin      := ./../../../Lib/cygwin32_llvm/libPhysX3CommonDEBUG_x86.a
...
$(PhysXCommon_debug_bin): $(PhysXCommon_debug_obj) 
	mkdir -p `dirname ./../../../Lib/cygwin32_llvm/libPhysX3CommonDEBUG_x86.a`
	##$(CXX) -shared $(PhysXCommon_debug_obj) $(PhysXCommon_debug_lflags) -lc -o $@ 
	@$(AR)  $(PhysXCommon_debug_bin) $(PhysXCommon_debug_obj)
...
PhysXCommon_checked_common_cflags  +=   -fPIC    -fno-exceptions -fno-rtti 
...
PhysXCommon_checked_lflags  += -ldl
...
PhysXCommon_checked_bin      := ./../../../Lib/cygwin32_llvm/libPhysX3CommonCHECKED_x86.a
...
$(PhysXCommon_checked_bin): $(PhysXCommon_checked_obj) 
	mkdir -p `dirname ./../../../Lib/cygwin32_llvm/libPhysX3CommonCHECKED_x86.a`
	##$(CXX) -shared $(PhysXCommon_checked_obj) $(PhysXCommon_checked_lflags) -lc -o $@ 
	@$(AR)  $(PhysXCommon_checked_bin) $(PhysXCommon_checked_obj)
	$(ECHO) building $@ complete!
...
PhysXCommon_profile_common_cflags  +=   -fPIC    -fno-exceptions -fno-rtti 
...
PhysXCommon_profile_lflags  += -ldl
...
PhysXCommon_profile_bin      := ./../../../Lib/cygwin32_llvm/libPhysX3CommonPROFILE_x86.a
...
$(PhysXCommon_profile_bin): $(PhysXCommon_profile_obj) 
	mkdir -p `dirname ./../../../Lib/cygwin32_llvm/libPhysX3CommonPROFILE_x86.a`
	##$(CXX) -shared $(PhysXCommon_profile_obj) $(PhysXCommon_profile_lflags) -lc -o $@ 
	@$(AR)  $(PhysXCommon_profile_bin) $(PhysXCommon_profile_obj)
	$(ECHO) building $@ complete!
...
PhysXCommon_release_common_cflags  +=   -fPIC    -fno-exceptions -fno-rtti 
...
PhysXCommon_release_lflags  += -ldl
...
PhysXCommon_release_bin      := ./../../../Lib/cygwin32_llvm/libPhysX3Common_x86.a
