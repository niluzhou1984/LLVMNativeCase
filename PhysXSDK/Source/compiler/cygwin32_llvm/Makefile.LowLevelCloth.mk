...
LowLevelCloth_debug_common_cflags  +=   -fPIC   -fno-exceptions -fno-rtti  
...
LowLevelCloth_debug_lflags  += -ldl
...
LowLevelCloth_debug_bin      := ./../../../Lib/cygwin32_llvm/libLowLevelClothDEBUG.a
...
$(LowLevelCloth_debug_bin): $(LowLevelCloth_debug_obj) 
	mkdir -p `dirname ./../../../Lib/cygwin32_llvm/libLowLevelClothDEBUG.a`
	@$(AR)  $(LowLevelCloth_debug_bin) $(LowLevelCloth_debug_obj)
...
LowLevelCloth_checked_common_cflags  +=   -fPIC   -fno-exceptions -fno-rtti  
...
LowLevelCloth_checked_lflags  += -ldl
...
LowLevelCloth_checked_bin      := ./../../../Lib/cygwin32_llvm/libLowLevelClothCHECKED.a
...
$(LowLevelCloth_checked_bin): $(LowLevelCloth_checked_obj) 
	mkdir -p `dirname ./../../../Lib/cygwin32_llvm/libLowLevelClothCHECKED.a`
	@$(AR)  $(LowLevelCloth_checked_bin) $(LowLevelCloth_checked_obj)
	$(ECHO) building $@ complete!
...
LowLevelCloth_profile_common_cflags  +=   -fPIC   -fno-exceptions -fno-rtti  
...
LowLevelCloth_profile_lflags  += -ldl
...
LowLevelCloth_profile_bin      := ./../../../Lib/cygwin32_llvm/libLowLevelClothPROFILE.a
...
$(LowLevelCloth_profile_bin): $(LowLevelCloth_profile_obj) 
	mkdir -p `dirname ./../../../Lib/cygwin32_llvm/libLowLevelClothPROFILE.a`
	@$(AR)  $(LowLevelCloth_profile_bin) $(LowLevelCloth_profile_obj)
	$(ECHO) building $@ complete!
...
LowLevelCloth_release_common_cflags  +=   -fPIC   -fno-exceptions -fno-rtti  
...
LowLevelCloth_release_lflags  += -ldl
...
LowLevelCloth_release_bin      := ./../../../Lib/cygwin32_llvm/libLowLevelCloth.a
...
$(LowLevelCloth_release_bin): $(LowLevelCloth_release_obj) 
	mkdir -p `dirname ./../../../Lib/cygwin32_llvm/libLowLevelCloth.a`
	@$(AR)  $(LowLevelCloth_release_bin) $(LowLevelCloth_release_obj)
	$(ECHO) building $@ complete!
